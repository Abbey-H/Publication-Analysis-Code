...
dataGEN <- "MARSRR_GenData.csv" #give name of datafile
...
head(difStm) #give first 6 observations of difStm dataframe
```
...
head(difAvgGrp) #give first 6 observations of difAvgGrp dataframe
```
...
tail(difStmGrp) #give last 6 observations of difStmGrp dataframe
```
